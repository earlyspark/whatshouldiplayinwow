      ...
      <div className="mx-auto w-full max-w-[78rem] px-5 sm:px-8">
        ...
        <article>
          <section className="space-y-5">
            ...
            <p className="t-body text-[var(--dim)]">Your first-ranked choices matter most. Ranking both healing and damage gives Priest an extra signal for a Discipline-style mix. Ranking protection and damage with disruption can favor Warlock&apos;s pet and curses; ranking adaptation favors classes that can switch group jobs. Frustrations and a preference for focused play can count against a class that might feel like a poor fit, without ruling it out. The same answers and game data always lead to the same result. Class fit is chosen before race fit, so a race preference cannot change your class.</p>
