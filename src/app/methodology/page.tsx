        ...
        <article>
          ...
          <section id="privacy" className="surface mt-12 space-y-5 p-6 sm:p-8" aria-labelledby="privacy-title">
            ...
            <p className="t-small text-[var(--dim)]">
              This quiz saves your answers, recommendation, result ID, data version, and creation date so your result link can be shared. Results are stored for 90 days after creation, then expire. Anyone with your result link can view that result.
            </p>
            <p className="t-small text-[var(--dim)]">
            ...
            <p className="t-small text-[var(--dim)]">
              Rating a recommendation is optional and does not require analytics consent. Only the quiz-taker with the creator receipt in this tab session can rate the main pick and either alternative; people opening a shared link cannot vote. We store one current thumbs-up or thumbs-down vote per pick and result ID until that result expires. Changing a vote replaces the old one. The quiz stats page shows only aggregate counts for the first, second, and third picks, which remain after individual results expire. Other visitors cannot see your ratings on the shared result page.
            </p>
            <p className="t-small text-[var(--dim)]">
