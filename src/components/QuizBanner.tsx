...
export default function QuizBanner({ questionIndex }: QuizBannerProps) {
  ...
  return (
    <aside
      className="surface mt-6 flex w-full items-center gap-4 p-4"
    ...
    >
      ...
      <div className="min-w-0">
        ...
        <AmazonProductLink
          ...
          asin={product.asin}
          placement="inline"
          className="focus-ring t-small mt-1 block truncate font-semibold text-[var(--bronze)] hover:text-[var(--bone)]"
        >
          {product.title}
        </AmazonProductLink>
        <span className="t-small mt-0.5 block text-[var(--dim)]">
